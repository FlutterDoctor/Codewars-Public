...
//Instructions: This kata is the first of a sequence of four about "Squared Strings".
...
//solution
String vertMirror(String srt) => srt.split('').reversed.join().split('\n').reversed.join('\n');
String horMirror(String srt)=> srt.split('\n').reversed.join('\n');
String oper(String fct(String srt), String s)=> fct(s);
